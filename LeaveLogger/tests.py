...
class BaseViewTest(APITestCase):
    ...
    def setUp(self):
        # add test data
        self.create_employee("emp001t", "0113116412",
                             "TestName001", "TestSurname001")
        self.create_employee("emp002t", "0113116413",
                             "TestName002", "TestSurname002")
        self.create_employee("emp003t", "0113116414",
                             "TestName003", "TestSurname003")
        self.create_employee("emp004t", "0113116415",
                             "TestName004", "TestSurname004")
